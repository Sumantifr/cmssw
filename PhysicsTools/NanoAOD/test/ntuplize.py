...
# with command line options: NANO -s NANO --mc --conditions 126X_mcRun3_2022_realistic_v2 --era Run3,run3_nanoAOD_124 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 -n -1 --no_exec --filein file:c5355a89-2ebe-4612-be7f-b3363de0df91.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/s/sesanche/public/forSuman/c5355a89-2ebe-4612-be7f-b3363de0df91.root'),
